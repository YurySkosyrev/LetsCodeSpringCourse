...
public class MainControllerTest {
    ...
    public void messageListTest() throws Exception {
        ...
        // рассчитываем, что у нас будет определенное количество элементов
        // на странице при этом добавим атрибут message-list для списка сообщений
    }
    ...
    public void messageFilterTest() throws Exception {
        ...
        // проверим количество сообщений с тегом my-tag
        // добавим в css атрибут data-id, чтобы проверять id сообщения
    }
    ...
    public void addMessageToListTest() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//*[@id='message-list']/div/div[@data-id=10]/div/span").string("fifth"))
                .andExpect(xpath("//*[@id='message-list']/div/div[@data-id=10]/div/i").string("new one"));
        // знаем, что id нового сообщения к 4 добавленным с помощью скрипта будет 10
    }
